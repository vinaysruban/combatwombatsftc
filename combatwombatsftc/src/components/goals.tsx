...
const goalsList = [
    ...
    ["/icons/bhasu.jfif", "Bhasu Madala", "Head of Documentation", "Logging our experiences", "For the 2024 FTC season, our goal in documentation is to ensure every part of our team's process in developing our robot is clearly documented and organised in a portfolio that will be easy for the judges as well as other teams to understand. Our current focus in organising the records of our processes to meet the specific criteria for awards such as the Inspire Award. We will make sure that our experiences we gain during the process of preparing for competitions are clearly showcased as a helpful guide for other teams to better themselves and their robot.", "3"],
    ["/icons/shainthra.jfif", "Shainthra Birabaharan", "Head of Outreach", "We're in touch with our community", "For the 2023-2024 FTC season, our team intends to bump up our outreach game to promote STEM and FIRST better than we ever have. We aim to push ourselves with outreach by aiming to get each person in our team to take initiative on planning and actioning an outreach experience. We have already begun planning many of these experiences and are aiming to put them into action as soon as possible.", "4"],
]
