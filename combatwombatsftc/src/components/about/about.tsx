    ...
    <div className="">
        ...
        >
          ...
          <p className="my-6 sm:my-12 2xl:my-16 text-lg 2xl:text-xl 4xl:text-2xl text-gray-800 dark:text-gray-200 mb-8 text-center max-w-screen-lg mx-auto">
            Our journey is coming to it&apos;s climax, and we are excited to
            share our story with you. Let&apos;s hope you take our learnings and
        ...
        <div
          data-aos="fade-up"
          className="slider shadow-md overflow-hidden my-6"
        >
          ...
          <div data-aos="fade-up">
            ...
            >
              ...
              <p className="text-base md:text-lg 2xl:text-xl text-left my-6">
                The website was developed using NextJS (TypeScript) +
                TailwindCSS, with scrolling animations through AOS JS. Docs were
                created using MarkDown, formatted through Gray Matter, with the
                use of KaTeX for LaTeX and PrismJS for syntax highlighting.
              </p>
