...
function normalise(n: number, max: number, direction: number, magnitude: number): number {
...
export default function Outreach() {
  ...
  const images = [image1Ref, image2Ref, image3Ref];
  ...
  return (
    <div className="container mx-auto py-36 3xl:py-64 4xl:py-80 sm:py-24 md:pt-36 xl:pt-48 3xl:pt-60 px-4">
      <main className="mb-36 md:mb-64">
        <h1 className="text-5xl sm:text-6xl md:text-7xl xl:text-8xl 3xl:text-9xl 4xl:text-10xl font-bold text-center z-10 relative">
          ...
          <Image
            ...
            width={1000}
            height={1000}
            className={`object-cover w-[3.5em] h-[2.25em] absolute left-[30%] sm:left-[40%] bottom-[-250%] ms:bottom-[-500%] sm:bottom-[-400%] md:bottom-[-350%] rounded-xl rotate-12 z-0 brightness-50`}
          />
