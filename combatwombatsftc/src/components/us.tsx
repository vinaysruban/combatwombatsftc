    ...
    <div className="relative">
      ...
      >
        <div className="mx-auto">
          <h1 className="font-bold text-3xl ms:text-4xl before:h-2 sm:text-5xl sm:before:h-2 md:text-6xl md:before:h-3 lg:text-7xl lg:before:h-4 mx-auto block w-fit mb-12 popup relative" data-aos="fade-up">
            Meet our team!
          </h1>
