    ...
    <div className="relative">
      ...
      >
        <div className="mx-auto">
          <h1 className="font-bold text-3xl ms:text-4xl before:h-2 sm:text-5xl sm:before:h-2 md:text-6xl md:before:h-3 lg:text-7xl lg:before:h-4 mx-auto block w-fit mb-12 popup relative">
            Meet our team!
          </h1>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="mx-auto h-24 w-24 sm:h-32 sm:w-32 2xl:w-44 2xl:h-44 4xl:h-64 4xl:w-64 rounded-full mb-4 object-cover bg-github bg-cover hover"
                />
