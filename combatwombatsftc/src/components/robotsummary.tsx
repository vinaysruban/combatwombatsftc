export default function RobotSummary() {
  return (
    <section className="bg-combatgreen px-12 py-16">
      ...
      <p className="font-medium md:text-xl 2xl:text-2xl max-w-screen-lg mx-auto">Yappity yappity yap. you gotta talk about the robot here juan. like the shi surrounding it and engage the audeince</p>
