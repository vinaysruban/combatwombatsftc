...
export default async function Page(params: any) {
  ...
  return (
    <section className={`${mdstyles.wrapper} ${mdstyles.base} ${roboto.className}`}>
      <PrismProvider />
      <GoBack path="/docs" />
      <header>
        <h1>{post.title}</h1>
